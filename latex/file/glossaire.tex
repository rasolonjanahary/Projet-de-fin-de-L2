...
Dans cette section, nous allons définir tous les termes techniques et acronymes utilisés dans notre rapport.
...
\begin{itemize}
	...
	\item \textbf{visualisation} : l'utilisation de graphiques pour représenter les données.
	\item \textbf{web scraping / scraper} : le processus d'extraction de données à partir de sites web.
