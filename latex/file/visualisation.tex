...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{../figures/pie_research.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{../figures/boxplot_research_admit.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{../figures/bar_research_counts.png}
