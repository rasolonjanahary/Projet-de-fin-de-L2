...
Pour pouvoir analysé la distribution du variable TOEFL Score, on a utilisé la visualisation par histogramme pour mieux voir sa distribution comme on peut constater sur la figure ci-dessous.
\begin{figure}[H]
	\centering
...
Pour pouvoir analysé la distribution du variable University Rating, on a encore utilisé la visualisation par histogramme pour mieux voir sa distribution comme on voit sur la figure ci-dessous.
\begin{figure}[H]
	\centering
...
Pour mieux analyser la relation entre la variable GRE Score et Chance of Admit, on a utilisé la visulaisation par nuage de point comme on peut le voir sur la figure ci-dessous.
\begin{figure}[H]
	\centering
...
Pour mieux analyser la relation entre la variable CGPA et Chance of Admit, on a utilisé la visulaisation par nuage de point comme on peut le voir sur la figure ci-dessous.
\begin{figure}[H]
	\centering
...
Pour mieux analyser la relation entre la variable TOEFL Score et Chance of Admit, on a utilisé la visulaisation par nuage de point comme on peut le voir sur la figure ci-dessous.
\begin{figure}[H]
	\centering
...
Pour mieux analyser la relation Chance of Admit et expérience de recherche, on a utilisé la visualisation par boîte à moustaches car on peut voir la résumé de la ditribution, la médiane et les valeurs extrêmes comme on peut voir ci-dessous.
\begin{figure}[H]
	\centering
