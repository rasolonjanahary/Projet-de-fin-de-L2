...
L'établissement a été fondé le \textbf{17 août 2021} et son siège se
trouve à \textbf{Ankazotokana Ambanidia, Lot VF 32 Ter}.

Pour tout renseignement, vous pouvez nous contacter par email à
\textbf{contact@insi.mg} ou visiter notre site web :
\href{http://www.insi.mg/}{www.insi.mg}

INSI University bénéficie du soutien d'entreprises partenaires, dont
\textbf{Ilo Madagascar SARLU} et \textbf{Data Pulse Center}, qui sont
...
INSI University a été fondée le \textbf{17 août 2021} à Antananarivo,
...
Créé à l'initiative de \textbf{Ilo Madagascar SARLU} et \textbf{Data
...
La mission principale de l'INSI est de \textbf{former des experts
...
Le \textbf{Président} \textbf{Directeur Général} assure la direction
...
La \textbf{Direction Administrative et Financière} est chargée de la
gestion des affaires internes, notamment à travers deux services
essentiels : le service des \textbf{scolarités}, qui s'occupe des
dossiers étudiants, inscriptions et suivi académique, et les
\textbf{services supports et stratégiques}, qui assurent un appui
logistique, administratif et technologique à l'ensemble de l'institut.

Le pôle des \textbf{Relations Internationales et Mobilités} gère les
échanges académiques avec l'étranger ainsi que les projets de mobilité
étudiante ou enseignante.

La \textbf{Direction des Études} supervise quant à elle l'ensemble des
programmes pédagogiques et le corps enseignant. Elle travaille en
étroite collaboration avec un \textbf{Responsable Parcours}, qui
coordonne les différentes spécialisations proposées. Cette direction
intègre également une cellule dédiée à la \textbf{formation
...
\textbf{Département alternance et emplois}, responsable du suivi des
étudiants en contrat d'alternance, des stages professionnels, et de
l'insertion professionnelle.

Sous la partie \textbf{Responsable Parcours}, plusieurs responsables
pédagogiques gèrent les différentes filières de formation : le
\textbf{parcours tronc commun}, qui regroupe les matières fondamentales
partagées par tous les étudiants en début de cycle ; le \textbf{parcours
	ARSB \& IC}; le \textbf{parcours GL \& MSI} ; et enfin le
\textbf{parcours IAD \& I2AD}.
...
Le \textbf{Conseil de l'École,} Il regroupe des membres de l'équipe
...
Le \textbf{responsable de la formation en ligne}, Il conçoit et
...
L'\textbf{Association et Clubs étudiants}, encadre et soutient les
...
INSI University propose des \textbf{parcours académiques
...
\textbf{GL (Génie Logiciel)} : Conception, développement et maintenance
d\textquotesingle applications logicielles.

\textbf{ARSB (Administration Réseaux et Systèmes et Base de données)} :
Gestion d'infrastructures informatiques, réseaux, serveurs et systèmes.

\textbf{IAD (Intelligence Artificielle et Data Science)} : Introduction
...
\textbf{MSI (Management des Systèmes d'Information)} : Pilotage de
projets numériques, gouvernance des SI.

\textbf{IC (Infrastructures et Cybersécurités)} : Sécurisation des
systèmes, audit, réseaux avancés.

\textbf{I2AD (Intelligence Artificielle, Analyse de Données et
...
\begin{itemize}
	\item
	Niveau \textbf{DALF C1} en français pour la mobilité vers des pays
	francophones.
	\item
	Niveau \textbf{B2 ou C1} en anglais pour les destinations anglophones.
	
	\begin{enumerate}
		\def\labelenumi{\arabic{enumi}.}
		\item
		\textbf{Architectures des formations pédagogiques}
	\end{enumerate}
\end{itemize}
...
\textbf{Tableau 1~: Les parcours en Licence et Master}

\begin{longtable}[]{@{}
		>{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5021}}
	...
	Administration Réseaux, Systèmes et Bases de données (ARSB) &
	Infrastructures et Cybersécurités (IC) \\
	Intelligence Artificielle et Data Science (IAD) & Intelligence
	Artificielle, Analyse de Données et Automatisation (I2AD) \\
	\bottomrule()
\end{longtable}
...
L = Licence (Bac + 3) = L1, L2, L3 = 6 \textbf{semestres S1 à S6}
...
En plus des stages, l'INSI organise régulièrement des \textbf{visites
	pédagogiques}, des \textbf{rencontres métiers} et des \textbf{projets
...
grâce à son partenaire fondateur, \textbf{ILO Madagascar}, représentant
de l'Organisation Internationale du Travail. Cette orientation se
renforce aujourd'hui à travers des \textbf{partenariats stratégiques
...
L'INSI bénéficie actuellement de \textbf{programmes de co-diplomation et
...
pédagogique, mais aussi d'ouvrir des perspectives de \textbf{mobilité
	académique} et \textbf{professionnelle} aux étudiants, en leur offrant
une reconnaissance de leurs compétences à l'échelle internationale.

Par ailleurs, à travers les \textbf{stages annuels} et \textbf{projets
...
\textbf{écosystème global}, plaçant l'Institut comme un acteur majeur de
...
Grâce aux \textbf{partenariats internationaux} et aux \textbf{projets en
	entreprise}, les diplômés du Master peuvent également prétendre à des
postes dans des structures \textbf{multinationales}, ou poursuivre une
carrière \textbf{académique et de recherche} (doctorat, enseignement
supérieur).
